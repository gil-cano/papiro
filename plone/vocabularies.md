...
Terminologia en [Vocabularios](https://4.docs.plone.org/external/plone.app.dexterity/docs/advanced/vocabularies.html)
...
The `token`
 must be an ASCII string. It is the value passed with the request when the form is submitted. A token must uniquely identify a term.
